...
public class DictionaryManagement extends Dictionary {
    ...
    private static final String DATA_FILE_PATH = "C:\\Users\\Rukitori\\Documents\\IntelliJ Project\\Dictionary\\src\\sample\\E_V.txt";
    ...
    public void ChangeWord(String word, String mean, String typeWord, String spelling) throws IOException {
        File inFile = new File(DATA_FILE_PATH);
        if (!inFile.isFile()) {
            return;
        }
